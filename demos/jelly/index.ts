...
// We already set some styles in HTML, but let's keep these or adapt them.
// The original script sets height: 100vh, flex, etc.
// I've set most of that in CSS in index.html.
